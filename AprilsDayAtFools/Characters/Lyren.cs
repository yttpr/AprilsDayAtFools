...
namespace AprilsDayAtFools
{
    public static class Lyren
    {
        public static void Add()
        {
            ...
            novelty1.Description = "Lose Constricting as a Passive.\nDeal 6 damage to the Opposing enemy and move them Left or Right, then produce 2 Blue Pigment.\nRegain Constricting as a Passive.";
            ...
            novelty2.Description = "Lose Constricting as a Passive.\nDeal 9 damage to the Opposing enemy and move them Left or Right, then produce 2 Blue Pigment.\nRegain Constricting as a Passive.";
            ...
            novelty3.Description = "Lose Constricting as a Passive.\nDeal 11 damage to the Opposing enemy and move them Left or Right, then produce 2 Blue Pigment.\nRegain Constricting as a Passive.";
            ...
            novelty4.Description = "Lose Constricting as a Passive.\nDeal 13 damage to the Opposing enemy and move them Left or Right, then produce 2 Blue Pigment.\nRegain Constricting as a Passive.";
            novelty4.Effects[1].entryVariable = 13;

            Ability sing1 = new Ability("Sing Trust", "Lyren_Sing_1_A");
            sing1.Description = "Lose Constricting as a Passive.\nDeal 5 indirect damage and inflict 1 Ruptured to the Left and Right enemies, then move them towards this party member.\nRegain Constricting as a Passive.";
            ...
            sing2.Description = "Lose Constricting as a Passive.\nDeal 7 indirect damage and inflict 1 Ruptured to the Left and Right enemies, then move them towards this party member.\nRegain Constricting as a Passive.";
            ...
            sing3.Description = "Lose Constricting as a Passive.\nDeal 8 indirect damage and inflict 3 Ruptured to the Left and Right enemies, then move them towards this party member.\nRegain Constricting as a Passive.";
            ...
            sing4.Description = "Lose Constricting as a Passive.\nDeal 10 indirect damage and inflict 3 Ruptured to the Left and Right enemies, then move them towards this party member.\nRegain Constricting as a Passive.";
