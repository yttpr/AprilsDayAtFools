...
namespace AprilsDayAtFools
{
    public static class Six
    {
        public static void Add()
        {
            ...
            days1.Description = "Deal 3 damage to the Opposing enemy and gain an equivalent amount of Shield.\nIf no damage is dealt, instantly flee and spawn a permenant copy of this character.";
            ...
            days2.Description = "Deal 4 damage to the Opposing enemy and gain an equivalent amount of Shield.\nIf no damage is dealt, instantly flee and spawn a permenant copy of this character.";
            days2.Effects[0].entryVariable = 4;

            Ability days3 = new Ability(days2.ability, "Six_Days_3_A", days1.Cost);
            days3.Name = "Six Minutes";
            days3.Description = "Deal 5 damage to the Opposing enemy and gain an equivalent amount of Shield.\nIf no damage is dealt, instantly flee and spawn a permenant copy of this character.";
            ...
            days4.Description = "Deal 6 damage to the Opposing enemy and gain an equivalent amount of Shield.\nIf no damage is dealt, instantly flee and spawn a permenant copy of this character.";
            ...
            fingers1.Effects[2] = Effects.GenerateEffect(cost, 1, Slots.Self, BasicEffects.DidThat(true, 2));
            fingers1.Effects[3] = Effects.GenerateEffect(flee, 1, Slots.Self, BasicEffects.DidThat(true, 3));
            fingers1.Effects[4] = Effects.GenerateEffect(clone, 1, Slots.Self, BasicEffects.DidThat(true, 4));
            fingers1.AddIntentsToTarget(Slots.Front, ["Damage_3_6"]);
            //fucks up the order of intents cuz of the randomized one but oh well
            fingers1.AddIntentsToTarget(Slots.Self, ["PA_Fleeting", "Other_Spawn"]);
            ...
            //fingers1.Effects[0] = Effects.GenerateEffect(BasicEffects.Empty, )
            hearts1.Effects[0] = Effects.GenerateEffect(cost, 1, Slots.Self);
            hearts1.Effects[1] = Effects.GenerateEffect(flee, 1, Slots.Self);
            hearts1.Effects[2] = Effects.GenerateEffect(clone, 1, Slots.Self);
