...
namespace AprilsDayAtFools
{
    public static class Moon
    {
        public static void Add()
        {
            ...
            FireDamageByStoredValueBlockedByFieldCascadeEffect isolDmg = ScriptableObject.CreateInstance<FireDamageByStoredValueBlockedByFieldCascadeEffect>();
            isolDmg._increaseDamage = false;
            isolDmg.m_unitStoredDataID = IDs.Isolation;
            isolDmg._Field = StatusField.OnFire;
            isolDmg._cascadeDecrease = 50;
            isolDmg._decreaseAsPercentage = true;
            isolDmg._cascadeIsIndirect = true;
            ...
            isol1.Description = "Deal 10 direct Fire damage to the Opposing position and decrease this move's damage by 2, resetting if it would reach 0. The damage is entirely blocked by Fire and spreads indirectly to adjacent enemies.\nThis move's damage decreases by 2 on turn end and on taking any damage.\nInflict 1 Fire on this party member.";
            ...
            isol1.Effects[0] = Effects.GenerateEffect(isolDmg, 10, Targeting.GenerateSlotTarget([0, 1, 2, 3, 4, -1, -2, -3, -4], false));
            ...
            isol1.AddIntentsToTarget(Slots.Left, ["Swap_Left"]);
            isol1.AddIntentsToTarget(Slots.Front, ["Damage_7_10"]);
            isol1.AddIntentsToTarget(Slots.Right, ["Swap_Right"]);
            ...
            isol2.Description = "Deal 13 direct Fire damage to the Opposing position and decrease this move's damage by 3, resetting if it would reach 0. The damage is entirely blocked by Fire and spreads indirectly to adjacent enemies.\nThis move's damage decreases by 2 on turn end and on taking any damage.\nInflict 1 Fire on this party member.";
            isol2.Effects[0].entryVariable = 13;
            isol2.Effects[1].entryVariable = 3;
            isol2.Effects[2].entryVariable = 13;
            isol2.EffectIntents[1].intents[0] = "Damage_11_15";

            Ability isol3 = new Ability(isol2.ability, "Moon_Isolation_3_A", isol1.Cost);
            isol3.Name = "Burning Isolation";
            isol3.Description = "Deal 16 direct Fire damage to the Opposing position and decrease this move's damage by 4, resetting if it would reach 0. The damage is entirely blocked by Fire and spreads indirectly to adjacent enemies.\nThis move's damage decreases by 2 on turn end and on taking any damage.\nInflict 1 Fire on this party member.";
            isol3.Effects[0].entryVariable = 16;
            isol3.Effects[1].entryVariable = 4;
            isol3.Effects[2].entryVariable = 16;
            isol3.EffectIntents[1].intents[0] = "Damage_16_20";
            ...
            light2.Description = "Inflict 1 Fire to this party member and 2-3 Fire to the Opposing enemy.\nRestore the damage of \"Isolation\" and \"Wallowing\" to their bases; their damages won't decrease at the end of this turn.";
            ...
            light4.Description = "Inflict 1 Fire to this party member and 3 Fire to the Opposing enemy.\nRestore the damage of \"Isolation\" and \"Wallowing\" to their bases; their damages won't decrease at the end of this turn.";
