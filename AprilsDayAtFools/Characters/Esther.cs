...
namespace AprilsDayAtFools
{
    public static class Esther
    {
        ...
        public static void Items()
        {
            ...
            FirstDamageUpItemCondition damage_up = ScriptableObject.CreateInstance<FirstDamageUpItemCondition>();
            damage_up.ID = "Aprils_Beheading_TW";
            PerformEffect_Item beheading = new PerformEffect_Item("Aprils_Beheading_TW", [Effects.GenerateEffect(ScriptableObject.CreateInstance<LosePlayerCurrencyEffect>(), 7, Slots.Self)]);
            beheading.Name = "Beheading";
            beheading.Flavour = "\"Oh, woe is me!\"";
            beheading.Description = "The first time this party member does damage each combat, increase it by 7.\nOn being directly damaged, destroy this item and lose 7 coins.";
            beheading.Icon = ResourceLoader.LoadSprite("item_beheading.png");
            beheading.EquippedModifiers = [];
            ...
            beheading.ConsumeOnTrigger = TriggerCalls.OnWillApplyDamage;
            beheading.ConsumeOnUse = true;
            beheading.ConsumeConditions = [damage_up];
            beheading.ShopPrice = 0;
            beheading.IsShopItem = true;
